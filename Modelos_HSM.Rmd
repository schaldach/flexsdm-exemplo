...
######> O método em si é quase equivalente ao sample_pseudoabs, ele usa o 
######> próprio método, mas aqui irá ser para a área de estudo inteira
set.seed(random_seed) 
...
mglm <-
  fit_glm(
    ...
    partition = ".part",
    thr = "max_sens_spec"
    ######> As diferentes métricas (thresholds) são explicadas na página da função
