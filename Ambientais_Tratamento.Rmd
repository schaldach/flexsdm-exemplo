...
Este código não é obrigatório caso você já tenha um arquivo .tif com todas as variáveis ambientais que serão usadas para os Modelos de Adequação de Habitat. O objetivo dele é ajudar a você organizar os dados ambientais no padrão esperado pelo código dos Modelos.
